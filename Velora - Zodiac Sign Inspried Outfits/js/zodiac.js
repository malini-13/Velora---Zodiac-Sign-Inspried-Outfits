    ...
    function render(productId) {
      ...
      detail.innerHTML = `
        <div class="zodiac-visual">
          <img src="${product.image}" alt="${product.zodiac} zodiac inspired luxury fashion outfit by Velora" loading="lazy" onerror="this.onerror=null;this.src='assets/products/placeholder.svg';">
        </div>
